...
public class JBCQuotaManagerUtil
{
    ...
    */
   public static MappedParametrizedObjectEntry prepareJBCParameters(InitParams initParams)
   ...
   private static void putDefaultValues(MappedParametrizedObjectEntry qmEntry)
   {
   ...
   private static void putAppropriateColumnTypesValues(MappedParametrizedObjectEntry qmEntry) throws RepositoryException
   {
   ...
   private static class QuotaManagerEntry extends MappedParametrizedObjectEntry
   {
   }
}
